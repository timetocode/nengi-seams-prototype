...
import consoleLogLogo from 'nengi/core/common/consoleLogLogo';
...
class PIXIRenderer {
    ...
    createEntity(entity) {
        if (this.entities.get(entity.nid)) {
            return
        }
        ...
        if (entity.protocol.name === 'GreenCircle') {
            ...
            //console.log('created', entity.nid)
            this.entities.set(entity.nid, clientEntity)
            this.middleground.addChild(clientEntity)
        }
    }
    ...
    deleteEntity(nid) {
       ...
       // console.log('deleting', nid)
        ...
        if (entity) {
            //console.log('removing from middleground')
